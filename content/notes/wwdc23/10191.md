...
Object Capture utilizes cutting-edge computer vision technologies to generate realistic 3D models from a series of images captured from different angles. Initially introduced for macOS in WWDC21, it is now also available for iOS 17 and above. If you want a recap of Object Capture for macOS, you can check out this [link](https://www.wwdcnotes.com/notes/wwdc21/10076/).
...
> Note: The sample app recommends to always complete the three scan passes before finishing.
...
> If an error occurs during the process, the session enters the failed state, requiring the creation of a new session.
